...
import com.sparta.beckendproject.controller.request.PostRequestDto;
import com.sparta.beckendproject.controller.response.CommentResponseDto;
import com.sparta.beckendproject.controller.response.PostResponseDto;
...
import com.sparta.beckendproject.repository.CommentRepository;
import com.sparta.beckendproject.repository.PostRepository;
  ...
  public ResponseDto<?> createPost(PostRequestDto requestDto, HttpServletRequest request) {
    if (null == request.getHeader("Refresh-Token")) {
      return ResponseDto.fail("MEMBER_NOT_FOUND",
          "로그인이 필요합니다.");
      //Header에 Refresh-Token이 null이면 fail
    }

    if (null == request.getHeader("Authorization")) {
      return ResponseDto.fail("MEMBER_NOT_FOUND",
          "로그인이 필요합니다.");
      //헤더에 Token이 null이면 fail
    }
